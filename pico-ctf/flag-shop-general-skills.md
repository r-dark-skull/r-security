...
Here, `account_balance` is `1100` and `flag` cost is `100000` .
...
![](<../assets\_md/Pasted image 20220524192230.png>)

Since, `number_flags` and `total_cost` are **integer values** we can overflow them, to make negative.

![](<../assets\_md/Pasted image 20220524193007.png>)

![](<../assets\_md/Pasted image 20220524195126.png>)

![](<../assets\_md/Pasted image 20220524204515.png>)

![](<../assets\_md/Pasted image 20220524204654.png>)
